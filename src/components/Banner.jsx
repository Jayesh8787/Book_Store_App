...
import banner from "../../public/hero-img.png";
        ...
        <div className="max-w-screen-2xl mb-3 container mx-auto md:px-20 px-4 flex flex-col my-16 md:flex-row">
          <div className="md:w-1/2 order-2 md:order-1 w-full mt-8 md:mt-20">
            <div className="space-y-8">
              ...
              <label className="input input-bordered flex items-center gap-2 rounded-[10px]">
                <svg
          ...
          <div className="rounded-md md:w-1/2 order-1 w-full">
